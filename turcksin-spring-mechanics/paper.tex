...
\begin{wrapfigure}{L}{0.28\textwidth}
  \begin{center}
    \vspace*{-24pt}
    \includegraphics[width=0.25\textwidth]{figures/graph.png}
    \vspace*{-12pt}
  \end{center}
...
In practice, once you have accumulated a number of testcases, running and
comparing them by hand using the commands above becomes unwieldy. In such
...
talk about a better naming scheme to make it easier to find test cases to clone
