...
\begin{wrapfigure}{R}{0.2\textwidth}
  \begin{center}
    \vspace*{-24pt}
    \includegraphics[width=0.18\textwidth]{tests/testcase-1.png}
    \vspace*{-12pt}
  \end{center}
...
canvas.plot(y_values[:,0], y_values[:,1], y_values[:,2], label='body 1')
canvas.plot(y_values[:,3], y_values[:,4], y_values[:,5], label='body 2')
